net.Receive("SerialNumbers.InitiateSerialScratch", function()
    ...
    if lia.gui and IsValid(lia.gui.menu) then lia.gui.menu:Remove() end
    ...
    weaponsFrame.Paint = function(self, w, h) draw.RoundedBox(8, 0, 0, w, h, Color(30, 30, 30)) end
    ...
    ListView.PaintHeader = function(self, w, h) draw.RoundedBox(0, 0, 0, w, h, Color(40, 40, 40)) end
    ...
    ListView.Paint = function(self, w, h)
        for _, line in pairs(self.Lines) do
            line.Paint = function(self, w, h) draw.RoundedBox(0, 0, 0, w, h, Color(50, 50, 50)) end
        end
    end
    ...
    ListView.OnRowSelected = function(_, _, row)
        ...
        weaponsFrame:AlphaTo(0, 0.2, 0, function() weaponsFrame:Remove() end)
        ...
        countdownFrame.Paint = function(self, w, h) draw.RoundedBox(8, 0, 0, w, h, Color(30, 30, 30)) end
