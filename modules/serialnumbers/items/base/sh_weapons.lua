...
function ITEM:onInstanced()
    if self:getData("SerialNumber") == nil then MODULE:registerSerialNumberEtc(self) end
end
...
ITEM.functions.zcopy = {
    ...
    onCanRun = function(item) return not IsValid(item.entity) and not item:getData("SerialNumber_Scratched") end,
}
